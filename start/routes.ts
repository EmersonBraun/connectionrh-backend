...
Route
  .group(() => {
    ...
    Route.get('new-plans','NewPlansController.index')
    Route.post('new-plans/search','NewPlansController.search')
...
Route
  .group(() => {
    ...
    Route.resource('new-plans','NewPlansController').except(['index'])
    ...
    Route.resource('public-articles','PublicArticlesController').apiOnly()
    Route.resource('public-partners','PublicPartnersController').apiOnly()
    Route.resource('public-plans','PublicNewPlansController').apiOnly()
    Route.resource('public-vacancies','PublicVacanciesController').apiOnly()
  })
  .prefix('/api')
  // .middleware('auth')
