...
Route
  .group(() => {
    ...
    Route.resource('application_status','ApplicationStatusesController').apiOnly()
    ...
    Route.resource('contract_types','ContractTypesController').apiOnly()
    Route.resource('courses','CoursesController').apiOnly()
    Route.resource('detached_plans','DetachedPlansController').apiOnly()
    ...
    Route.resource('post_categories','PostCategoriesController').apiOnly()
    Route.resource('purchased_candidates','PurchasedCandidatesController').apiOnly()
    Route.resource('purchased_requests','PurchasedRequestsController').apiOnly()
    Route.resource('recomends','RecomendsController').apiOnly()
    Route.resource('request_statuses','RequestStatusesController').apiOnly()
    Route.resource('roles','RolesController').apiOnly()
    Route.resource('skills','SkillsController').apiOnly()
    Route.resource('strong_points','StrongPointsController').apiOnly()
