...
import UsersHasInstitution from 'App/Models/UsersHasInstitution'
import { mountResponse } from 'App/Services/ResponseUtils'
import { all, create, createOrUpdate, find, findAndDelete, findAndUpdate, first } from '../Services/CRUD'

class CoursesCandidateRepository {
  protected model: any

  constructor () {
    this.model = UsersHasInstitution
  }
...
export default new CoursesCandidateRepository()
